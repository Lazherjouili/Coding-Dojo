...
<div class=" mt-8 ml-64 mr-64 ">
<h1 class="font-bold tracking-wider text-3xl  w-full text-violet-600">Book Club</h1>
<p class="font-bold text-2xl">A place for friends to share thoughts on books</p>
...
<section class=" flex flex-col items-start">
            ...
            <div class="flex flex-1 items-center justify-center">
                <div class="rounded-lg sm:border-2 px-4 lg:px-20 py-8 lg:max-w-xl sm:max-w-md w-full text-center">
